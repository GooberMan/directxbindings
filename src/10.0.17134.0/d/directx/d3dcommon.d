...
version (Windows) { version = D3DCommonEnable; }
else { static assert( false, "D3D is only enabled for Windows." ); }

version( D3DCommonEnable ):
@system:
extern( C ):
...
extern( C ) extern const IID IID_ID3D10Blob;
...
extern( C ) extern const IID IID_ID3DDestructionNotifier;
...
extern( Windows ) interface ID3DInclude
{
	HRESULT Open(
...
enum UUID WKPDID_D3DDebugObjectName = {
	0x429b8c22,
	0x9188,
	0x4b0c,
...
enum UUID WKPDID_D3DDebugObjectNameW = {
	0x4cca5fd8,
	0x921f,
	0x42c8,
...
enum UUID WKPDID_CommentStringW = {
	0xd0149dc0,
	0x90e8,
	0x4ec8,
	[ 0x81, 0x44, 0xe9, 0x00, 0xad, 0x26, 0x6b, 0xb2 ]
};

//pragma( inline, true ) D3D_SET_OBJECT_NAME_N_A(pObject, Chars, pName) (pObject)->SetPrivateData(WKPDID_D3DDebugObjectName, Chars, pName)
//pragma( inline, true ) D3D_SET_OBJECT_NAME_A(pObject, pName) D3D_SET_OBJECT_NAME_N_A(pObject, lstrlenA(pName), pName)
//pragma( inline, true ) D3D_SET_OBJECT_NAME_N_W(pObject, Chars, pName) (pObject)->SetPrivateData(WKPDID_D3DDebugObjectNameW, Chars*2, pName)
//pragma( inline, true ) D3D_SET_OBJECT_NAME_W(pObject, pName) D3D_SET_OBJECT_NAME_N_W(pObject, wcslen(pName), pName)
